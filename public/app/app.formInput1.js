        ...
        switch (cat) {
            ...
            case 'mobile': {
                ...
                showMobile = '<div class="panel panel-primary">' +
                    '<div class="panel-heading">' +
                    '<h3 class="panel-title">' +
                    this.myAd[lastIndex].x.company + ' ' + this.myAd[lastIndex].x.model +
                    '</h3>' +
                    '</div>' +
                    '<div class="panel-body row">' +
                    '<div class= "col-sm-4">' +
...
//# sourceMappingURL=app.formInput1.js.map